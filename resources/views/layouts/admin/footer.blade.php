...
<script src="{{asset('js/radial_active.js')}}"></script>
<script src="{{asset('js/stackbar.js')}}"></script>
<script src="{{asset('js/area_chart.js')}}"></script>

<script src="{{asset('js/bar_active_1.js')}}"></script>
